                        ...
                        <Grid container justifyContent="space-between" spacing={gridSpacing}>
                          <Grid item xs={12}>
                            <Grid container justifyContent="flex-end" spacing={1}>
                              ...
                              <Grid item>
                                <ButtonBase component={Link} href="https://twitter.com/kevnnard" target="_blank">
                                  <Avatar
                                    sx={{
                                      ...theme.typography.commonAvatar,
                                      ...theme.typography.mediumAvatar,
                              ...
                              <Grid item>
                                <ButtonBase component={Link} href="https://github.com/kevnnard" target="_blank">
                                  <Avatar
                                    sx={{
                                      ...theme.typography.commonAvatar,
                                      ...theme.typography.mediumAvatar,
